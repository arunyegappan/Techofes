 ...
 <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js"></script>
	...
	CLICK ON THE FILM NAMES TO GET THE DETAILS
		...
		<div id="mb_menu" class="mb_menu">
			<a href="#" data-speed="1000" data-easing="easeOutBack">APOORVA RAAGANGAL</a>
			
		</div>
		<div id="mb_content_wrapper" class="mb_content_wrapper">
			<span class="mb_close"></span>
			<div class="mb_content">
				<h2>Apoorva Raagangal</h2>
				<div class="mb_content_inner">
					Language: TAMIL

<p>Director : K.BALACHANDAR</p>

<p>Music : M.S.VISWANATHAN</p>

<p>Cast : Kamal Hassan,Srividya,Major Sundarrajan,Jayasudha,Nagesh</p>

<p>Release date : 18.08.1975 </p>

<p>Wiki link :<a href=" http://en.wikipedia.org/wiki/Apoorva_Raagangal"> http://en.wikipedia.org/wiki/Apoorva_Raagangal</a></p>
				</div>
			</div>
