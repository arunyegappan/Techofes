	...
	$("a[rel='tab']").mouseover(function(e){
		...
		*/
		...
		$.ajax({url:pageurl+'?rel=tab',success: function(data){
			$("#eventsinner").load(pageurl+"/?click='yes'");
		}});
 ...
 <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js"></script>
	...
	CLICK ON THE FILM NAMES TO GET THE DETAILS
		...
		<div id="mb_menu" class="mb_menu">
			...
			<a href="#" data-speed="1000" data-easing="easeInExpo">Johny</a>
			<a href="#" data-speed="1000" data-easing="easeOutBack">Kaali</a>
			<a href="#" data-speed="1000" data-easing="easeInExpo">Kaali</a>
			<a href="#" data-speed="1000" data-easing="easeInExpo">Mayadari krishnudhu</a>
			<a href="#" data-speed="1000" data-easing="easeOutBack">Murattu kaalai</a>
			<a href="#" data-speed="1000" data-easing="easeInExpo">Naan potta savaal</a>
			<a href="#" data-speed="1000" data-easing="easeInExpo">Pollathavan</a>
...
<p>Director : Mahendran</p>

<p>Music : Ilayaraja </p>

<p>Cast : Rajinikanth , Sridevi , Deepa Unnimary , Prabhakar Reddy , Kanchana </p>

<p>Release date : 15.08.1980</p>
...
<p>Director :  I.V.Sasi</p>

<p>Music : Ilaiyaraja</p>

<p>Cast : Rajinikanth , Chiranjeevi , Seema</p>

<p>Release date : 19.09.1980 </p>
...
<p>Cast : Rajinikanth  </p>

<p>Release date : 19.07.1980</p>


				</div>
			</div>
			<div class="mb_content">
				<h2>Murattu Kaalai</h2>
				<div class="mb_content_inner">
...
<p>Cast : Rajinikanth ,JaiShankar , Rati Agnihotri , Sumalatha</p>

<p>Release date : 20.12.1980  </p>


				</div>
			</div>
			<div class="mb_content">
				<h2>Naan Potta Savaal</h2>
				<div class="mb_content_inner">
					

<p>Language: Tamil </p>

<p>Director : Puratchidasan</p>

<p>Music  : Ilayaraja</p>

<p>Cast : Rajinikanth , Reena Roy , M.R.Radha , Manorama , Major Sundarrajan</p>

<p>Release date : 07.08.1980</p>
...
<p>Director : V.Srinivashan </p>

<p>Music : M.S.V</p>

<p>Cast : Rajinikanth , Lakshmi , SriPriya , Sivachandran , Suruli Rajan </p>

<p>Release date : 06.11.1980</p>
