 ...
 <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js"></script>
	...
	CLICK ON THE FILM NAMES TO GET THE DETAILS
		...
		<div id="mb_menu" class="mb_menu">
			...
			<a href="#" data-speed="1000" data-easing="easeInExpo">Velaikaran</a>
			<a href="#" data-speed="1000" data-easing="easeOutBack">Insaff Kaun Karega</a>
			<a href="#" data-speed="1000" data-easing="easeInExpo">Oorkavalan</a>
			<a href="#" data-speed="1000" data-easing="easeInExpo">Manithan</a>
			<a href="#" data-speed="1000" data-easing="easeOutBack">Uttar Dakshin</a>
...
<p>Cast : Rajinikanth , Amala , Sarathbabu , Naasar </p>

<p>Release date : 07.03.1987</p>

<p>Wiki link :<a href=" http://en.wikipedia.org/wiki/Velaikaaran"> http://en.wikipedia.org/wiki/Velaikaaran</a></p>
				</div>
			</div>
			<div class="mb_content">
				<h2>Insaff Kaun Karega</h2>
				<div class="mb_content_inner">
					

<p>Language: Hindi</p>

<p>Director :  Suradshan Nag</p>

<p>Music : Lakshmikant Pyarelal</p>

<p>Cast : Rajinikanth , Suresh Bokadia , Dharmendra , Jayaprabha</p>

<p>Release date : 19.06.1987</p>

 <p>Wiki link :<a href=" http://en.wikipedia.org/wiki/Insaff_Kaun_Karega"> http://en.wikipedia.org/wiki/Insaff kaun karega </a></p>
				</div>
			</div>
			<div class="mb_content">
				<h2>Oorkavalan</h2>
...
<p>Director : Manobala  </p>

<p>Music  : G.Thiyagarajan</p>

<p>Cast : Rajinikanth , Radhika , Raghuvaran</p>

<p>Release date : 04.09.1987</p>

<p>Wiki link :<a href=" http://en.wikipedia.org/wiki/Oorkavalan"> http://en.wikipedia.org/wiki/Oorkavalan </a></p>
				</div>
			</div>
...
<p>Cast : Rajinikanth , M.Saravanan , Rubini , Srividya , Raghuvaran </p>

<p>Release date : 21.10.1987</p>

<p>Wiki link :<a href=" http://en.wikipedia.org/wiki/Manithan"> http://en.wikipedia.org/wiki/Manithan</a></p>
				</div>
			</div>
			<div class="mb_content">
				<h2>Uttar Dakshin</h2>
...
<p>Director : Prabhat khanna</p>

<p>Music : Lakshmikant Pyrelal</p>

<p>Cast : Rajinikanth , Ashok khanna , Maduri Dixit , Jackie Shroff </p>

<p>Release date : 13.11.1987 </p>

<p>Wiki link :<a href=" http://en.wikipedia.org/wiki/Uttar_Dakshin"> http://en.wikipedia.org/wiki/Uttar_Dakshin </a></p>
				</div>
			</div>
