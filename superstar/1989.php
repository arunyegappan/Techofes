 ...
 <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js"></script>
	...
	CLICK ON THE FILM NAMES TO GET THE DETAILS
		...
		<div id="mb_menu" class="mb_menu">
			...
			<a href="#" data-speed="1000" data-easing="easeInExpo">Rajathi Raja</a>
			<a href="#" data-speed="1000" data-easing="easeInExpo">Siva</a>
			<a href="#" data-speed="1000" data-easing="easeInExpo">Raja Chinna Roja</a>
			<a href="#" data-speed="1000" data-easing="easeInExpo">Mappillai</a>
			<a href="#" data-speed="1000" data-easing="easeInExpo">Bhrashtachar</a>
			<a href="#" data-speed="1000" data-easing="easeInExpo">Chaalbaaz</a>
			</div>
...
<p>Director : R.Sundarrajan</p>

<p>Music : Ilayaraja</p>

<p>Cast : Rajinikanth , Radha , Janakaraj </p>

<p>Producer : R.D.Baskar </p>

<p>Release date : 04.03.1989 </p>

<p>Wiki link :<a href=" http://en.wikipedia.org/wiki/Rajathi_Raja"> http://en.wikipedia.org/wiki/Rajathi_Raja</a></p>
				</div>
			</div>
			<div class="mb_content">
				<h2>Siva</h2>
...
<p>Director : Ammerjan</p>

<p>Music  : Ilayaraja</p>

<p>Cast : Rainikanth, Shobhana , Raghuvaran</p>

<p>Producer : K.Balachander</p>

<p>Release date : 05.05.1989 </p>

<p>Wiki link :<a href=" http://en.wikipedia.org/wiki/Siva_(1989_Tamil_film)">  http://en.wikipedia.org/wiki/Guru_Sishyan</a></p>
				</div>
			</div>
			<div class="mb_content">
				<h2>Raja Chinna Roja</h2>
				<div class="mb_content_inner">
...
<p>Cast : Rajinikanth , Gouthami , Raaghuvaran , Baby Shalini</p>

<p>Producer : M.Saravanan ,M.S.Guhan </p>

<p>Release date : 20.07.1989 </p>

<p>Wiki link :<a href="http://en.wikipedia.org/wiki/Raja_Chinna_Roja">http://en.wikipedia.org/wiki/Raja_Chinna_Roja</a></p>
				</div>
			</div>
...
<p>Director : Rajasekar</p>

<p>Music : Ilayaraja </p>

<p>Cast : Rajinikanth , Amala, Janaki</p>

<p>Producer : Chiranjeevi </p>

<p>Release date : 28.10.1989 </p>

<p>Wiki link :<a href=" http://en.wikipedia.org/wiki/Mappillai_(1989_film)">http://en.wikipedia.org/wiki/Mappillai</a></p>
				</div>
			</div>
...
<p>Director : Ramesh Sippy</p>

<p>Music : Lakshmikant Pyrelal</p>

<p>Cast : Rajinikanth , Mithun Chakraborty , Rekha</p>

<p>Producer :  G.P.Sippy </p>

<p>Release date : 01.12.1989 </p>

<p>Wiki link :<a href=" http://en.wikipedia.org/wiki/Bhrashtachar">http://en.wikipedia.org/wiki/Bhrashtachar</a></p>
				</div>
			</div>
...
<p>Director : Pankaj Prashar</p>

<p>Music : Lakshmikant Pyrelal</p>

<p>Cast : Rajinikanth , Sunny Deol , Sridevi</p>

<p>Producer :  Poorna Chandra Rao </p>

<p>Release date : 08.12.1989 </p>

<p>Wiki link :<a href=" http://en.wikipedia.org/wiki/ChaalBaaz">http://en.wikipedia.org/wiki/ChaalBaaz</a></p>
				</div>
			</div>
		</div>
		</div>
