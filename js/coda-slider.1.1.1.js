	...
	return this.each(function(){
		...
		container.each(function(i) {
			...
			jQuery("div#stripNav" + j + " a").each(function(z) {
				...
				// What happens when a nav link is mouseovered
			...
			jQuery("a.cross-link").mouseover(function(){
				jQuery(this).parents().find(".stripNav ul li a:eq(" + (parseInt(jQuery(this).attr("href").slice(1)) - 1) + ")").trigger('mouseover');
			});	
