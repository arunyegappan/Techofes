...
$(function(){
	$("a[rel='cont']").mouseover(function(e){
	...
	jQuery(".conl").attr("id","techofes");	
	jQuery(".conm").attr("id","techofes");	
  ...
  $.ajax({url:pageurl,success: function(data){
   ...
   $("#cdetails").ajaxStop(function(){
		...
		jQuery(".conl").attr("id","con");
		jQuery(".conm").attr("id","con");
		jQuery("."+x).attr("id","techofes");
  });
...
$(function(){
	$("a[rel='spo']").mouseover(function(e){
